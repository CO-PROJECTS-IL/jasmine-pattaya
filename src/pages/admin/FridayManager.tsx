...
export default function FridayManager() {
  ...
  return (
    <>
      ...
      {/* Cancel Section */}
      <div className="rounded-xl p-4 mb-6" style={{ backgroundColor: 'white', border: '1px solid oklch(0.93 0.004 255)', boxShadow: '0 1px 4px oklch(0.20 0.02 60 / 0.06)' }}>
      ...
      <div className="space-y-2 mb-6">
        {menuItems.map((item: any) => (
          <div key={item.id} className="flex items-center justify-between p-3 rounded-xl" style={{ backgroundColor: 'white', border: '1px solid oklch(0.93 0.004 255)', boxShadow: '0 1px 4px oklch(0.20 0.02 60 / 0.06)' }}>
            <div>
      ...
      <div className="space-y-2">
        {bookings.map((booking: any) => (
          <div key={booking.id} className="p-4 rounded-xl" style={{ backgroundColor: 'white', border: '1px solid oklch(0.93 0.004 255)', boxShadow: '0 1px 4px oklch(0.20 0.02 60 / 0.06)' }}>
